...
const CartItem = ({ name, price, id, quantity }) => {
  return `<div class="cart__item">
    ...
    <div class="card__quantity">
      <i style="margin-right: .5rem;" class="fas fa-plus quan-inc"></i>
      <span class="card__quan-num" style="font-size: 1.5rem;" >${quantity}</span>
      <i style="margin-left: .5rem;" class="fas fa-minus quan-dec"></i>
    </div>
